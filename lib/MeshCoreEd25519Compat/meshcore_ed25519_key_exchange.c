...
// reference implementation (lib/ed25519/key_exchange.c in meshcore-dev/MeshCore,
...
// concatenated. Deliberately NOT named "key_exchange.c" -- a quoted #include always
